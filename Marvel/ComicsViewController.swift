...
class ComicsViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request(String(format: "https://gateway.marvel.com/v1/public/characters/%i/comics?ts=%i&apikey=%@&hash=%@&limit=%i", id, timestamp, public_key, md5_hash, request_limit), method: .get).validate().responseJSON { response in
            ...
            case .success(let value):
                ...
                for i in 0..<json["data"]["results"].count
                {
                    ...
                    self.comicsList.append(json["data"]["results"][i]["title"].string!);
                ...
                for (index, value) in self.comicsList.enumerated() {
                    print("Item \(index + 1): \(value)")
                }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.label?.text = self.comicsList[indexPath.row];
